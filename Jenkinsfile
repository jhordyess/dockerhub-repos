pipeline {
  ...
  environment {
    REPOSITORIES_JSON = '[{"name": "java", "version": "17-3"}, {"name": "latino", "version": "1.4"}, {"name": "node", "version": "18"}, {"name": "platformio", "version": "6.1"}, {"name": "texlive", "version": "2024-small"}, {"name": "ubuntu", "version": "22.04"}]',
